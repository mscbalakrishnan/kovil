...
$(function() {
    ...
    var signupValidationSettings = {
	    ...
	    messages: {
			...
			mail:{
				...
				email:"Please enter the valid E-mail",
			},
			date:{
    ...
    $('#new_employee').validate(signupValidationSettings);
});

//Update Employee
$(function() {
	if (!$('#update_employee').length) {
        return false;
    }
    var signupValidationSettings = {
	    rules: {
	    ...
	    messages: {
			...
			pf:{
				required:"Please enter the PF no.",
			},
			esi:{
				required:"Please enter the ESI no.",
			},
			hr:{
				required:"Please enter the HR",
			},
			dra:{
				required:"Please enter the DRA",
			},
			gp:{
				required:"Please enter the Gross Pay",
			},
			area:{
				required:"Please enter the address",
			},
    ...
    $('#update_employee').validate(signupValidationSettings);
});
...
$(function() {
	...
	$.extend(signupValidationSettings, config.validations);
    $('#admin').validate(signupValidationSettings);
});
...
// var monkeyList = new List('card items', {
  // valueNames: ['name'],
  // page: 3,
  // pagination: true
// });
